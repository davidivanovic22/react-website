        ...
        <div className="main-container" ref={element}>
            ...
            <div className="container">
                <motion.div className="content"
                    ...
                    <h1>
                        We Provide Solutions to Help You to Build Grow Your Business!
                    </h1>
                    <p>
                        A professional web and mobile app development agency with over 100+ web and app developed. We
                        provide a high-quality service in web and mobile app development as well as in design.
                    </p>
